...
export function Hero() {
  ...
  return (
    <section
      id="hero"
      ref={ref}
      className="snap-section relative lg:min-h-screen flex flex-col justify-start px-6 md:px-12 lg:px-20 pt-12 md:pt-32 lg:pt-36 pb-12 border-b border-slate-900/5 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto w-full relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
        <div className="max-w-2xl">
          ...
          <div className="flex items-center gap-3 sm:gap-4 reveal stagger-3 mb-10">
            <a
              href="#work"
              className="inline-flex items-center gap-1.5 sm:gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-full bg-green-500 text-white text-[13px] sm:text-sm font-semibold whitespace-nowrap hover:bg-green-600 transition-all hover:scale-[1.03] hover:shadow-lg hover:shadow-green-500/25"
            >
              View Our Work
            ...
            <a
              href="#contact"
              className="inline-flex items-center gap-1.5 sm:gap-2 px-5 sm:px-6 py-2.5 sm:py-3 rounded-full border border-slate-900/10 text-slate-900 text-[13px] sm:text-sm font-semibold whitespace-nowrap hover:bg-green-50 transition-all"
            >
              Discuss Project
            </a>
          </div>
